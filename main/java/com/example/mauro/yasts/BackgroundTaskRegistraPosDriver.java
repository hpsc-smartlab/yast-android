...
public class BackgroundTaskRegistraPosDriver extends AsyncTask<String, Void, String> {


    String register_url = "http://yasts.altervista.org/registerDriver.php";
    Context ctx;
    Activity activity;

    AlertDialog.Builder builder;

    public BackgroundTaskRegistraPosDriver(Context ctx){
        this.ctx = ctx;
