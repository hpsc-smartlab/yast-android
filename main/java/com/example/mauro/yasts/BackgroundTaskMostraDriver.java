...
public class BackgroundTaskMostraDriver extends AsyncTask<Object, Object, ArrayList> {
    ...
    String autisti_url = "http://yasts.altervista.org/driver.php";



    public BackgroundTaskMostraDriver(Context ctx){
        this.ctx = ctx;
