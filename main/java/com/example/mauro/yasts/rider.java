...
public class rider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentRider first = new fragmentRider();
        ...
        username = getIntent().getExtras().getString("username").trim();
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!checkConn) {
                        Toast.makeText(rider.this, "Connessione assente", Toast.LENGTH_LONG).show();
                    } else {
                        username = getIntent().getExtras().getString("username").trim();
                        BackgroundTaskBitWheels ruotini = new BackgroundTaskBitWheels(rider.this);
                        String user = null;
                        try {
            ...
            fab1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!checkConn) {
                        ...
                        Intent intent = new Intent(rider.this, schedaUtente.class);
            ...
            fab2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!checkConn) {
                        ...
                        nS = String.valueOf(n);
                        username = getIntent().getExtras().getString("username").trim();
                        BackgroundTaskRegalo regalo = new BackgroundTaskRegalo(rider.this);
                        try {
            ...
            case R.id.item1:
                ...
                miaAlert.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        BackgroundTaskLogout logout = new BackgroundTaskLogout(rider.this);
                        logout.execute(username,"1");
                        Toast.makeText(rider.this,"Alla prossima",Toast.LENGTH_LONG).show();
                        try {
                            Thread.sleep(100);
    ...
    public void onBackPressed() {
        ...
        miaAlert.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                BackgroundTaskLogout logout = new BackgroundTaskLogout(rider.this);
                logout.execute(username, "1");
                Intent intent = new Intent(rider.this,Splash.class);
